...
function AddTaskModal({ onAddTask, onClose }) {
  ...
  const submitTask = (event) => {
    ...
    onAddTask({ ...formData, title: formData.title.trim(), subject: formData.subject.trim() })
    onClose()
  }
